...
vector<int> ReadIntVectorFile(string dataName)
{
	vector<int> res;
	FILE* fp;	
	fp = fopen(dataName.c_str(), "r");
...
vector<float> ReadFloatVectorFile(string dataName)
{
	vector<float> res;
	FILE* fp;	
	fp = fopen(dataName.c_str(), "r");
...
vector<int> ReadIntVectorFile10(char* dataName)
{
	vector<int> res;
	FILE* fp;	
	fp = fopen(dataName, "r");
...
vector<float> ReadFloatVectorFile10(char* dataName)
{
	vector<float> res;
	FILE* fp;	
	fp = fopen(dataName, "r");
